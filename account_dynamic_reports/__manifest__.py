# -*- coding: utf-8 -*-
{
    'name' : 'All in one Dynamic Financial Reports v11',
    'version' : '11.0.2',
    'summary': 'General Ledger Trial Balance Ageing Balance Sheet Profit and Loss Cash Flow Dynamic',
    'sequence': 15,
    'description': """
                    Odoo 11 Full Accouning, Odoo 11 All in one Accouning, PDF Reports, XLSX Reports,
                    Dynamic View, Drill down, Clickable, Pdf and Xlsx package, Odoo 11 Accounting,
                    Full Account Reports, Complete Accounting Reports, Financial Report for Odoo 11,
    ...
    'website': '',
    'images': ['static/description/images/GL.gif'],
    'depends': ['account'],
    'data': ['data/data.xml',
             'views/views.xml',
